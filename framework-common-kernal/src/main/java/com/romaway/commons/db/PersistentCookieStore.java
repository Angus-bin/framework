...
public class PersistentCookieStore implements CookieStore {
    ...
    private static final String COOKIE_PREFS = "kds_data";
    ...
    public PersistentCookieStore(Context context) {
    	...
    	/*++[bug]cookie名字改了， 向低版本兼容 wanlh 2015/12/08*/
    	cookiePrefs = context.getSharedPreferences("CookiePrefsFile", 0);
    	String storedCookieNames = cookiePrefs.getString(COOKIE_NAME_STORE, null);
    	if(StringUtils.isEmpty(storedCookieNames))
        ...
        storedCookieNames = cookiePrefs.getString(COOKIE_NAME_STORE, null);
