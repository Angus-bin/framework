 ...
 * DBCopyHelper dbHelper = new DBCopyHelper(this);
...
public class DBCopyHelper extends SQLiteOpenHelper {
...
*/
    ...
    public DBCopyHelper(Context context, String name, CursorFactory factory, int version) {
    ...
    public DBCopyHelper(Context context,String appPackage,String dbName,int dbVersion){
        super(context, dbName, null, dbVersion);
        this.myContext = context;
    }

    public DBCopyHelper(Context context, String name, int version){

        this(context,DB_PATH,name,version);

    }

 

    public DBCopyHelper(Context context, String name){
