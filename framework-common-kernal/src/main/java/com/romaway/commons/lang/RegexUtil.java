/*
 * RegexUtil.java
 * classes : com.szkingdom.mobileservice.gphone.utils.RegexUtil
 * @author 缪运锦
 * V 1.0.0
 * Create at 2014-3-18 下午1:32:29
 */
...
/**
 * com.szkingdom.mobileservice.gphone.utils.RegexUtil
 */
public class RegexUtil {
  ...
  public static final Pattern FUND_CODE_PATTERN = Pattern.compile("[a-zA-Z0-9]");
   ...
   * @return
   */
  public static boolean isFundCode(String s){
      Matcher m = FUND_CODE_PATTERN.matcher(s);
      return m.matches();
  }
