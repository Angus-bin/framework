/*
 * ValidateUtil.java
 * classes : com.szkingdom.mobileservice.gphone.utils.ValidateUtil
 * @author 缪运锦
 * V 1.0.0
 * Create at 2014-3-18 下午1:31:21
 */
...
/**
 * com.szkingdom.mobileservice.gphone.utils.ValidateUtil
...
//  }
  ...
  public static boolean isPlateNo(EditText view) {
    ...
    String[] str1 = { "京", "津", "冀", "晋", "蒙", "辽", "吉", "黑", "沪", "苏", "浙", "皖", "闽", "赣", "鲁", "豫", "鄂", "湘", "粤",
        "桂", "琼", "渝", "川", "贵", "云", "藏", "陕", "甘", "青", "宁", "新", "农", "台", "中", "武", "WJ", "亥", "戌", "酉", "申", "未",
        "午", "巳", "辰", "卯", "寅", "丑", "子", "葵", "壬", "辛", "庚", "己", "戊", "丁", "丙", "乙", "甲", "河北", "山西", "北京", "北",
        "南", "兰", "沈", "济", "成", "广", "海", "空", "军", "京V", "使" };
  ...
  */
  ...
  public static boolean isMobileNumber(String mobile) {
    ...
    if (!RegexUtil.isMobileNumber(mobile.trim())) {    
      return false;
    }
    return true;
  }
  ...
  /** 银行帐号为16-21位的数字 */
  public static boolean isAccountNumber(String account) {
    if (StringUtils.isEmpty(account)){
        return false;
    }
      
    if (!RegexUtil.isAccountNumber(account.trim())) {
  ...
  /**
   * 检查输入的基金号码是否合法，只能包含字母和数字
   * @param code
   * @return 包含其他字符或者为空，则不合法
   */
  public static boolean isFundCode(String code){
      if (StringUtils.isEmpty(code)){
          return false;
      }
        
      if (!RegexUtil.isFundCode(code.trim())) {
