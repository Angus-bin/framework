...
/**
 * Created by hongrb on 2017/4/21.
 */
public class HttpUtils2 {
     ...
     * Param     :   params请求体内容，encode编码格式
     */
    public static String submitPostData(String strUrlPath, byte[] data, String encode, String cookie) {
//        byte[] data = getRequestData(params, encode).toString().getBytes();//获得请求体
    ...
    public static StringBuffer getRequestData(Map<String, String> params, String encode) {
        ...
        try {
            ...
            Log.d("MainActivity123123", "result = stringBuffer = " + stringBuffer.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return stringBuffer;
