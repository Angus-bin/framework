...
import com.romaway.framework.app.BaseActionBar;
 ...
 * </div>
 */
public abstract class ActionBar extends BaseActionBar{
    /**
    ...
    /**
     * Set the action bar's rzrqtitle. This will only be displayed if
     * {@link #DISPLAY_SHOW_TITLE} is set. Set to null to disable the
     * rzrqtitle entirely.
     *
     * @param subtitle Subtitle to set
     *
     * @see #setRzrqtitle(int)
     * @see #setDisplayOptions(int, int)
     */
    public abstract void setSubTitleLeft(CharSequence SubTitleLeft);
    ...
    /**
     * Returns the current ActionBar Rzrqtitle in standard mode.
     * Returns null if {@link #getNavigationMode()} would not return
     * {@link #NAVIGATION_MODE_STANDARD}.
     *
     * @return The current ActionBar Rzrqtitle or null.
     */
    public abstract CharSequence getRzrqtitle();
