...
import com.android.basephone.widget.BuildConfig;
...
public class ActionBarSherlockCompat extends ActionBarSherlock implements MenuBuilder.Callback, com.actionbarsherlock.view.Window.Callback, MenuPresenter.Callback, android.view.MenuItem.OnMenuItemClickListener {
    ...
    public void dispatchPostResume() {
        ...
        if (aActionBar != null) {
            aActionBar.setShowHideAnimationEnabled(false);//Ĭ�ϸ�Ϊû�ж���Ч��
        }
    }
    ...
    private void installDecor() {
        ...
        if (mContentParent == null) {
            ...
            if (wActionBar != null) {
                ...
                if (splitWhenNarrow) {
                    splitActionBar = ResourcesCompat.getResources_getBoolean(mActivity, R.bool.abs__split_action_bar_is_narrow);
                } else {
    ...
    private ViewGroup generateLayout() {
        ...
        if (!a.hasValue(R.styleable.SherlockTheme_ROMAwindowActionBar)) {
            throw new IllegalStateException("You must use Theme.Sherlock, Theme.Sherlock.Light, Theme.Sherlock.Light.DarkActionBar, or a derivative.");
        }

        if (a.getBoolean(R.styleable.SherlockTheme_ROMAwindowNoTitle, false)) {
            requestFeature(Window.FEATURE_NO_TITLE);
        } else if (a.getBoolean(R.styleable.SherlockTheme_ROMAwindowActionBar, false)) {
            // Don't allow an action bar if there is no title.
            requestFeature(Window.FEATURE_ACTION_BAR);
        }

        if (a.getBoolean(R.styleable.SherlockTheme_ROMAwindowActionBarOverlay, false)) {
            requestFeature(Window.FEATURE_ACTION_BAR_OVERLAY);
        }

        if (a.getBoolean(R.styleable.SherlockTheme_ROMAwindowActionModeOverlay, false)) {
