...
public class ActionMenuPresenter extends BaseMenuPresenter
    ...
    public void initForMenu(Context context, MenuBuilder menu) {
        ...
        if (!mMaxItemsSet) {
            mMaxItems = ResourcesCompat.getResources_getInteger(context, R.integer.abs__max_action_buttons);
        }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (!mMaxItemsSet) {
            mMaxItems = ResourcesCompat.getResources_getInteger(mContext,
    ...
    private class OverflowMenuButton extends ImageButton implements ActionMenuChildView, View_HasStateListenerSupport {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, R.attr.ROMAactionOverflowButtonStyle);
