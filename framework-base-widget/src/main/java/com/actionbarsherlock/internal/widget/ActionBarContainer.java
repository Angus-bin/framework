...
public class ActionBarContainer extends NineFrameLayout {
	...
	public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        mBackground = a.getDrawable(R.styleable.SherlockActionBar_ROMAbackground);
        mStackedBackground = a.getDrawable(
                R.styleable.SherlockActionBar_ROMAbackgroundStacked);
        ...
        if (getId() == R.id.abs__split_action_bar) {
            ...
            mSplitBackground = a.getDrawable(
                    R.styleable.SherlockActionBar_ROMAbackgroundSplit);
        }
        a.recycle();
