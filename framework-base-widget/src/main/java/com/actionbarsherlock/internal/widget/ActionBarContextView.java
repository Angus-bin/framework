...
public class ActionBarContextView extends AbsActionBarView implements AnimatorListener {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.ROMAactionModeStyle);
    }
	...
	public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        setBackgroundDrawable(a.getDrawable(
                R.styleable.SherlockActionMode_ROMAbackground));
        mTitleStyleRes = a.getResourceId(
                R.styleable.SherlockActionMode_ROMAtitleTextStyle, 0);
        mSubtitleStyleRes = a.getResourceId(
                R.styleable.SherlockActionMode_ROMAsubtitleTextStyle, 0);

        mContentHeight = a.getLayoutDimension(
                R.styleable.SherlockActionMode_ROMAheight, 0);

        mSplitBackground = a.getDrawable(
                R.styleable.SherlockActionMode_ROMAbackgroundSplit);
        
        TypedArray b = context.obtainStyledAttributes(attrs, R.styleable.SherlockActionBar,
                R.attr.ROMAactionBarStyle, 0);
        mTitleResId = b.getResourceId(
    ...
    private void initTitle() {
        if (mTitleLayout == null) {
            ...
            inflater.inflate(mTitleResId, this);
