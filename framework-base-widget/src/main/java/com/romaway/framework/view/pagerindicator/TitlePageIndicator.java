...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0/*R.attr.titlePageIndicatorStyle*/);
    }
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mFooterLineHeight = defaultFooterLineHeight;//a.getDimension(R.styleable.TitlePageIndicator_footerLineHeight, defaultFooterLineHeight);
        mFooterIndicatorStyle = IndicatorStyle.fromValue(defaultFooterIndicatorStyle/*a.getInteger(R.styleable.TitlePageIndicator_footerIndicatorStyle, defaultFooterIndicatorStyle)*/);
        mFooterIndicatorHeight = defaultFooterIndicatorHeight;//a.getDimension(R.styleable.TitlePageIndicator_footerIndicatorHeight, defaultFooterIndicatorHeight);
        mFooterIndicatorUnderlinePadding = defaultFooterIndicatorUnderlinePadding;//a.getDimension(R.styleable.TitlePageIndicator_footerIndicatorUnderlinePadding, defaultFooterIndicatorUnderlinePadding);
        mFooterPadding = defaultFooterPadding;//a.getDimension(R.styleable.TitlePageIndicator_footerPadding, defaultFooterPadding);
        mTopPadding = defaultTopPadding;//a.getDimension(R.styleable.TitlePageIndicator_topPadding, defaultTopPadding);
        mTitlePadding = defaultTitlePadding;//a.getDimension(R.styleable.TitlePageIndicator_titlePadding, defaultTitlePadding);
        mClipPadding = defaultClipPadding;//a.getDimension(R.styleable.TitlePageIndicator_clipPadding, defaultClipPadding);
        mColorSelected = defaultSelectedColor;//a.getColor(R.styleable.TitlePageIndicator_selectedColor, defaultSelectedColor);
        mColorText = defaultTextColor;//a.getColor(R.styleable.TitlePageIndicator_textColor, defaultTextColor);
        mBoldText = defaultSelectedBold;//a.getBoolean(R.styleable.TitlePageIndicator_selectedBold, defaultSelectedBold);

        final float textSize = defaultTextSize;//a.getDimension(R.styleable.TitlePageIndicator_textSize, defaultTextSize);
        final int footerColor = defaultFooterColor;//a.getColor(R.styleable.TitlePageIndicator_footerColor, defaultFooterColor);
