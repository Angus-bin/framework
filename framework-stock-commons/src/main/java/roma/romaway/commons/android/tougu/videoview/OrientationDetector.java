...
package roma.romaway.commons.android.tougu.videoview;
                ...
                public void onOrientationChanged(int orientation) {
                    ...
                    if (currDirection != lastDirection) {
                        ...
                        if (Logger.getDebugMode()) {
                            Logger.d(TAG, String.format("方向改变, 开始计时, 当前是方向为%s", currDirection));
                        }
                    } else {
                        calcHoldingTime();
                        if (holdingTime > HOLDING_THRESHOLD) {
                            if (currDirection == Direction.LANDSCAPE) {
                                if (currentOrientation != ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE) {
                                    Logger.d(TAG, "switch to SCREEN_ORIENTATION_LANDSCAPE");
                                ...
                                if (currentOrientation != ActivityInfo.SCREEN_ORIENTATION_PORTRAIT) {
                                    Logger.d(TAG, "switch to SCREEN_ORIENTATION_PORTRAIT");
                                ...
                                if (currentOrientation != ActivityInfo.SCREEN_ORIENTATION_REVERSE_PORTRAIT) {
                                    Logger.d(TAG, "switch to SCREEN_ORIENTATION_REVERSE_PORTRAIT");
                                ...
                                if (currentOrientation != ActivityInfo.SCREEN_ORIENTATION_REVERSE_LANDSCAPE) {
                                    Logger.d(TAG, "switch to SCREEN_ORIENTATION_REVERSE_LANDSCAPE");
...
//      Logger.d(TAG, "calcHoldingTime holdingTime=" + holdingTime);
        lastCalcTime = current;
    }
