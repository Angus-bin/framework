 ...
 * 
 */
public class HQBKProtocol extends AProtocol
{
	 ...
	 * @param cmdVersion
	 */
	public HQBKProtocol(String flag, int cmdVersion)
	{
		super(flag, ProtocolConstant.MF_HQ, HQ_BK, cmdVersion, true, false);
		this.subFunUrl = "/api/quote/pb_blockRank";// /api/quote/bankuai 这是原来的
		isBuffer=true;
	}
