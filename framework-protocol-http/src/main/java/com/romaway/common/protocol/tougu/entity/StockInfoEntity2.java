...
public class StockInfoEntity2 {
    ...
    public boolean equals(Object obj) {
        ...
        StockInfoEntity2 stockInfoEntity = (StockInfoEntity2)obj;
     ...
     * @param marketID
     */
    public StockInfoEntity2(String stockCode, String stockName, String marketID) {
        this.stockCode = stockCode;
        this.stockName = stockName;
        this.marketID = marketID;
    }

    public StockInfoEntity2(String stockCode, String stockName, String marketID, String cangWei) {
        this.stockCode = stockCode;
        this.stockName = stockName;
        this.marketID = marketID;
     ...
     * @param cangWei
     */
    public StockInfoEntity2(String stockCode, String stockName, String marketID, String cangWei, String latestPrice,
                            String bkCode, String bkName) {
        this.stockCode = stockCode;
        this.stockName = stockName;
        this.marketID = marketID;
        this.cangWei = cangWei;
     ...
     * @param priceZdf
     */
    public StockInfoEntity2(String stockCode, String stockName, String marketID, String stockType,
