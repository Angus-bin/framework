 ...
 *         自选行情协议
 */
public class HQZXProtocol extends AProtocol
{
	public final static short HQ_ZX = 3;
	...
	/**
	 * 如果是市场行情上面的大盘行情请求，就是用这个参数传参.此参数只在市场行情界面请求是赋值为4096
	 */
	public Long req_bitmap;
	 ...
	 * @param cmdVersion
	 */
	public HQZXProtocol(String flag, int cmdVersion)
	{
		super(flag, ProtocolConstant.MF_HQ, HQ_ZX, cmdVersion, true, false);
		subFunUrl = "/api/quote/pb_selected";
		isBuffer=true;
	}
