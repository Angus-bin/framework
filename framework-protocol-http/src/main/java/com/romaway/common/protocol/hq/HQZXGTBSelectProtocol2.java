...
public class HQZXGTBSelectProtocol2 extends AProtocol{
	/**
	 * 自选组名
	 */
	...
	public HQZXGTBSelectProtocol2(String flag) {
		super(flag, false);
		isJson = true;
		subFunUrl = "selfStock/myList";
	}
     ...
     */
    @Keep
    public static String[] parseZXGTBFavorsToArray(HQZXGTBSelectProtocol2 hqzxgtb){
