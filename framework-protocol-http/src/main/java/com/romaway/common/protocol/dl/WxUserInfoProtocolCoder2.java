 ...
 */
public class WxUserInfoProtocolCoder2 extends AProtocolCoder<WxUserInfoProtocol2> {
    @Override
    protected byte[] encode(WxUserInfoProtocol2 protocol) {
        /**
         * 设置请求body
         */
    ...
    @Override
    protected void decode(WxUserInfoProtocol2 protocol) throws ProtocolParserException {
