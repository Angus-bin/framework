...
public class HQZXGTBAddProtocolCoder extends AProtocolCoder<HQZXGTBAddProtocol>{

	@Override
	protected byte[] encode(HQZXGTBAddProtocol ptl) {
...
//		json.put("key_value", ptl.req_keyValue);
	...
	@Override
	protected void decode(HQZXGTBAddProtocol ptl) throws ProtocolParserException {
		...
		try {
			...
			ptl.serverErrCode = -1;
			ptl.serverMsg = "添加自选股" + stockCode + "失败";
		}
	}
