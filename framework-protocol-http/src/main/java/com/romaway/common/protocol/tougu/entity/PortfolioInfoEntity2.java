 ...
 */
public class PortfolioInfoEntity2 {

    public String bkCode;
    public String bkName;
    public String totalAmount;

    private List<StockInfoEntity2> mStockInfoEntityList;
    ...
    public Float getCangWei() {
        ...
        for (StockInfoEntity2 stockInfoEntity: mStockInfoEntityList)
            tempCangWei += Float.parseFloat(stockInfoEntity.cangWei);

        return tempCangWei;
    }

    public PortfolioInfoEntity2(String bkCode, String bkName, List<StockInfoEntity2> stockInfoEntityList){
        this.bkCode = bkCode;
        this.bkName = bkName;
