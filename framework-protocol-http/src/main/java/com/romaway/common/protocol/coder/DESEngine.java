...
public class DESEngine implements BlockCipher
{
    ...
    {
        workingKey = generateWorkingKey(encrypting, params.getKey());
    }
    ...
    private final static short[] Df_Key = { 0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef,
            0xfe, 0xdc, 0xba, 0x98, 0x76, 0x54, 0x32, 0x10, 0x89, 0xab, 0xcd,
            0xef, 0x01, 0x23, 0x45, 0x67 };

    private final  static short[] bytebit = { 0200, 0100, 040, 020, 010, 04, 02, 01 };

    private final   static int[] bigbyte = { 0x800000, 0x400000, 0x200000, 0x100000, 0x80000,
     ...
     */
    private final  static byte[] pc1 = { 56, 48, 40, 32, 24, 16, 8, 0, 57, 49, 41, 33, 25, 17,
            9, 1, 58, 50, 42, 34, 26, 18, 10, 2, 59, 51, 43, 35, 62, 54, 46,
            38, 30, 22, 14, 6, 61, 53, 45, 37, 29, 21, 13, 5, 60, 52, 44, 36,
            28, 20, 12, 4, 27, 19, 11, 3 };

    private final  static byte[] totrot = { 1, 2, 4, 6, 8, 10, 12, 14, 15, 17, 19, 21, 23, 25,
            27, 28 };

    private final  static byte[] pc2 = { 13, 16, 10, 23, 0, 4, 2, 27, 14, 5, 20, 9, 22, 18,
            11, 3, 25, 7, 15, 6, 26, 19, 12, 1, 40, 51, 30, 36, 46, 54, 29, 39,
            50, 44, 32, 47, 43, 48, 38, 55, 33, 52, 45, 41, 49, 35, 28, 31 };

    private final  static int[] SP1 = { 0x01010400, 0x00000000, 0x00010000, 0x01010404,
    ...
    private final  static int[] SP2 = { 0x80108020, 0x80008000, 0x00008000, 0x00108020,
    ...
    private final  static int[] SP3 = { 0x00000208, 0x08020200, 0x00000000, 0x08020008,
    ...
    private final   static int[] SP4 = { 0x00802001, 0x00002081, 0x00002081, 0x00000080,
    ...
    private final  static int[] SP5 = { 0x00000100, 0x02080100, 0x02080000, 0x42000100,
    ...
    private final  static int[] SP6 = { 0x20000010, 0x20400000, 0x00004000, 0x20404010,
    ...
    private final  static int[] SP7 = { 0x00200000, 0x04200002, 0x04000802, 0x00000000,
