...
public class HQZXGTBSelectProtocolCoder extends AProtocolCoder<HQZXGTBSelectProtocol>{

	@Override
	protected byte[] encode(HQZXGTBSelectProtocol ptl) {
...
//		json.put("key_value", ptl.req_keyValue);
	...
	@Override
	protected void decode(HQZXGTBSelectProtocol ptl) throws ProtocolParserException {
		...
		try {
			...
			ptl.resp_favors = json.getString("favors");
