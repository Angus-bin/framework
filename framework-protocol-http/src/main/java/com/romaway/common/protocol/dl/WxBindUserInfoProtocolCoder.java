 ...
 */
public class WxBindUserInfoProtocolCoder extends AProtocolCoder<WxBindUserInfoProtocol> {
    @Override
    protected byte[] encode(WxBindUserInfoProtocol protocol) {
        /**
         * 设置请求body
         */
    ...
    @Override
    protected void decode(WxBindUserInfoProtocol protocol) throws ProtocolParserException {
        ResponseDecoder r = new ResponseDecoder(protocol.getReceiveData());
        String result = r.getString();

        Logger.d("WxBindUserInfoProtocolCoder", "decode >>> result body = " + result);
