...
/**
 * Created by gfh on 2016/12/27.
 */

public class Base64And3DesUtils {
    // 密钥
    private final static String SECRETKEY        = "TFyZF8ZaBk4ErTazepPtvw4Pst2wfGLd";
    //定义 加密算法
     ...
     * @throws Exception
     */
    public static String dualEncrypt( String plainText ) throws Exception {
        Key deskey = null;
     ...
     * @throws Exception
     */
    public static String dualDecode( String encryptText ) throws Exception {
        Key deskey = null;
        DESedeKeySpec spec = new DESedeKeySpec( SECRETKEY.getBytes() );
        SecretKeyFactory keyfactory = SecretKeyFactory.getInstance( "DESede" );
        if (deskey == null) {
    ...
    public static class Base64 {
        ...
        public static String encode( byte[] byteData )
            ...
            return encode( byteData, Base64And3DesUtils.DEFAULT_ENCODING );
        }
		 ...
		 */
            for (reviSrcIdx = byteData.length; reviSrcIdx - 1 > 0
                                               && byteData[reviSrcIdx - 1] == '='; reviSrcIdx--) {
