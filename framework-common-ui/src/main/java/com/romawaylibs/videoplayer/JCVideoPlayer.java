 ...
 * On 2015/11/30 11:59
 */
public class JCVideoPlayer extends RelativeLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, SurfaceHolder.Callback, View.OnTouchListener {
    ...
    private void init(Context context) {
        View.inflate(context, R.layout.roma_libs_video_control_view, this);
        ...
        ivBack = (ImageView) findViewById(R.id.video_back);
...
//        surfaceView.setBackgroundColor(R.color.black_a10_color);
    ...
    public void setUp(String url, String thumb, String title, boolean ifShowTitle) {
        ...
        if(!TextUtils.isEmpty(thumb))
    		Picasso.with(context).load(thumb).into(ivThumb);
