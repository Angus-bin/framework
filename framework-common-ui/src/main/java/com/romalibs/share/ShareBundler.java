...
public class ShareBundler extends Dialog{
    ...
    private boolean isShowQQAndSinaWeiboShare;
	...
	private Runnable work = new Runnable() {
		public void run() {
			...
			if (orient != mScreenOrientation) {
				...
				((ShareBundler.MyAdapter) mGridView.getAdapter()).notifyDataSetChanged();
			}
	...
	public ShareBundler(Context context, int theme) {
		super(context, theme);
	}

	public void init(Context context) {
		
		final ArrayList<ShareItem> listData = new ArrayList<ShareItem>();
		listData.add(new ShareItem("wechat", "微信", R.drawable.roma_share_wechat,
				"com.tencent.mm.ui.tools.ShareImgUI", "com.tencent.mm"));
		listData.add(new ShareItem("wechatFriend", "微信朋友圈", R.drawable.roma_share_wechat_moments,
				"com.tencent.mm.ui.tools.ShareImgUI", "com.tencent.mm"));
        if(isShowQQAndSinaWeiboShare){
            listData.add(new ShareItem("sinaWeibo", "新浪微博", R.drawable.roma_share_sinaweibo,
                    "", ""));
            listData.add(new ShareItem("qqFriend", "QQ好友", R.drawable.roma_share_qq,
                    "com.tencent.mobileqq.activity.JumpActivity","com.tencent.mobileqq"));
            listData.add(new ShareItem("qqZone", "QQ空间", R.drawable.roma_share_qzone,
                    "com.tencent.mobileqq.activity.JumpActivity","com.tencent.mobileqq"));
        }
		...
		this.mLayout.setBackgroundColor(0xfff3f3f3);

		TextView tv = new TextView(getContext());
		mLayout.addView(tv);
		LinearLayout.LayoutParams layoutParams = 
				new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, -2);
		layoutParams.topMargin = ((int) (8.0F * mDensity));
		layoutParams.bottomMargin = ((int) (8.0F * mDensity));
		...
		LinearLayout.LayoutParams layoutParams1 = 
				new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, -2);
		layoutParams1.bottomMargin = ((int) (10.0F * mDensity)); 
		this.mGridView = new GridView(context);
		this.mGridView.setSelector(new ColorDrawable(Color.TRANSPARENT));
		this.mGridView.setLayoutParams(layoutParams1);
	...
	public boolean isInstallback(ShareItem share, String msg) {
		if (!share.packageName.isEmpty() && !isAvilible(getContext(), share.packageName)) {
			Toast.makeText(getContext(), "请先安装" + msg, Toast.LENGTH_SHORT).show();
			return false;
		}
    ...
    /**
     * 设置是否打开qq、qq空间与新浪微博分享
     *
     * @param showQQAndSinaWeiboShare
     */
    public void setShowQQAndSinaWeiboShare(boolean showQQAndSinaWeiboShare) {
        isShowQQAndSinaWeiboShare = showQQAndSinaWeiboShare;
    }
}
