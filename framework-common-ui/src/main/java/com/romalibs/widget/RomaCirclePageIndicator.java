 ...
 */
public class RomaCirclePageIndicator extends View implements PageIndicator {
    ...
    public RomaCirclePageIndicator(Context context) {
        this(context, null);
    }

    public RomaCirclePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0/*R.attr.circlePageIndicatorStyle*/);
    }

    @TargetApi(Build.VERSION_CODES.CUPCAKE)
	@SuppressLint("NewApi")
	public RomaCirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        //Load defaults from resources
        final Resources res = getResources();
        final int defaultFillColor = res.getColor(R.color.roma_libs_default_circle_indicator_fill_color);
        final int defaultOrientation = res.getInteger(R.integer.roma_libs_default_circle_indicator_orientation);
        final int defaultStrokeColor = res.getColor(R.color.roma_libs_default_circle_indicator_stroke_color);
        final float defaultStrokeWidth = res.getDimension(R.dimen.roma_libs_default_circle_indicator_stroke_width);
        final float defaultRadius = res.getDimension(R.dimen.roma_libs_default_circle_indicator_radius);
        final boolean defaultCentered = res.getBoolean(R.bool.roma_libs_default_circle_indicator_centered);
        final boolean defaultSnap = res.getBoolean(R.bool.roma_libs_default_circle_indicator_snap);
