...
public class UICenterProgressLayout extends RelativeLayout {
    ...
    private static final String TAG_LOADING = "UICenterProgressLayout.TAG_LOADING";
    private static final String TAG_EMPTY = "UICenterProgressLayout.TAG_EMPTY";
    private static final String TAG_ERROR = "UICenterProgressLayout.TAG_ERROR";
    ...
    public UICenterProgressLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init(attrs);
    }

    public UICenterProgressLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.UICenterProgressLayout);

        //Loading state attrs
        loadingStateProgressBarWidth =
                typedArray.getDimensionPixelSize(R.styleable.UICenterProgressLayout_loadingProgressBarWidth, 36);

        loadingStateProgressBarHeight =
                typedArray.getDimensionPixelSize(R.styleable.UICenterProgressLayout_loadingProgressBarHeight, 36);

        loadingStateBackgroundColor =
                typedArray.getColor(R.styleable.UICenterProgressLayout_loadingBackgroundColor, Color.TRANSPARENT);

        //Empty state attrs
        emptyStateImageWidth =
                typedArray.getDimensionPixelSize(R.styleable.UICenterProgressLayout_emptyImageWidth, 84);

        emptyStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.UICenterProgressLayout_emptyImageHeight, 84);

        emptyStateTitleTextSize =
                typedArray.getDimensionPixelSize(R.styleable.UICenterProgressLayout_emptyTitleTextSize, 12);

        emptyStateContentTextSize =
                typedArray.getDimensionPixelSize(R.styleable.UICenterProgressLayout_emptyContentTextSize, 11);

        emptyStateTitleTextColor =
                typedArray.getColor(R.styleable.UICenterProgressLayout_emptyTitleTextColor, Color.BLACK);

        emptyStateContentTextColor =
                typedArray.getColor(R.styleable.UICenterProgressLayout_emptyContentTextColor, Color.BLACK);

        emptyStateBackgroundColor =
                typedArray.getColor(R.styleable.UICenterProgressLayout_emptyBackgroundColor, Color.TRANSPARENT);

        //Error state attrs
        errorStateImageWidth =
                typedArray.getDimensionPixelSize(R.styleable.UICenterProgressLayout_errorImageWidth, 84);

        errorStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.UICenterProgressLayout_errorImageHeight, 84);

        errorStateTitleTextSize =
                typedArray.getDimensionPixelSize(R.styleable.UICenterProgressLayout_errorTitleTextSize, 12);

        errorStateContentTextSize =
                typedArray.getDimensionPixelSize(R.styleable.UICenterProgressLayout_errorContentTextSize, 11);

        errorStateTitleTextColor =
                typedArray.getColor(R.styleable.UICenterProgressLayout_errorTitleTextColor, Color.BLACK);

        errorStateContentTextColor =
                typedArray.getColor(R.styleable.UICenterProgressLayout_errorContentTextColor, Color.BLACK);

        errorStateButtonTextColor =
                typedArray.getColor(R.styleable.UICenterProgressLayout_errorButtonTextColor, Color.BLACK);

        errorStateBackgroundColor =
                typedArray.getColor(R.styleable.UICenterProgressLayout_errorBackgroundColor, Color.TRANSPARENT);
    ...
    public void showEmpty(/*Drawable emptyImageDrawable, */String emptyTextTitle, String emptyTextContent) {
        switchState(EMPTY, null/*emptyImageDrawable*/, emptyTextTitle, emptyTextContent, null, null, Collections.<Integer>emptyList());
    }
     ...
     * @param delayMillis
     */
    public void showEmpty(/*final Drawable emptyImageDrawable, */final String emptyTextTitle, final String emptyTextContent, long delayMillis) {
    ...
    public void showEmpty(/*Drawable emptyImageDrawable, */String emptyTextTitle, String emptyTextContent, List<Integer> skipIds) {
        switchState(EMPTY, null/*emptyImageDrawable*/, emptyTextTitle, emptyTextContent, null, null, skipIds);
    }
    ...
    public void showError(/*Drawable errorImageDrawable,*/ String errorTextTitle, String errorTextContent, String errorButtonText, View.OnClickListener onClickListener) {
        switchState(ERROR, null/*errorImageDrawable*/, errorTextTitle, errorTextContent, errorButtonText, onClickListener, Collections.<Integer>emptyList());
    }
    ...
    public void showError(/*Drawable errorImageDrawable, */String errorTextTitle, String errorTextContent, String errorButtonText, View.OnClickListener onClickListener, List<Integer> skipIds) {
        switchState(ERROR, null/*errorImageDrawable*/, errorTextTitle, errorTextContent, errorButtonText, onClickListener, skipIds);
    }
...
//		    	emptyStateImageView.setImageDrawable(drawable);
		    emptyStateImageView.setImageDrawable(
		    		ROMA_SkinManager.getDrawable(
		    				context,
		    				"kds_base_uicenter_empty",
		    				R.drawable.roma_base_uicenter_normal_empty
		    		));
//		    	PicassoHelper.load(context, emptyStateImageView, 
//		        		SkinManager.getIcon(context,
//						"kds_base_uicenter_empty", 
//						R.drawable.roma_base_uicenter_normal_empty));
...
//		    	errorStateImageView.setImageDrawable(drawable);
		    errorStateImageView.setImageDrawable(
		    		ROMA_SkinManager.getDrawable(
		    				context,
		    				"kds_base_uicenter_error",
		    				R.drawable.roma_base_uicenter_normal_net_error
		    		));
...
//		    }
    ...
    private void setLoadingView() {
        if (loadingStateRelativeLayout == null) {
            view = inflater.inflate(R.layout.roma_libs_progress_loading_view, null);
            ...
            ProgressBar loadingStateProgressBar = (ProgressBar) view.findViewById(R.id.loadingStateProgressBar);
    ...
    private void setEmptyView() {
        if (emptyStateRelativeLayout == null) {
            view = inflater.inflate(R.layout.roma_libs_progress_empty_view, null);
     ...
     * @param drawable
     */
    public void setEmptyStateColor(int titleColor, int contentColor, Drawable drawable) {
    	emptyStateTitleTextColor = titleColor;
    	emptyStateContentTextColor = contentColor;
    	emptyStateTitleTextView.setTextColor(emptyStateTitleTextColor);
        emptyStateContentTextView.setTextColor(emptyStateContentTextColor);
    	emptyStateImageView.setImageDrawable(drawable);
    }
    ...
    /**
     * 设置空状态下的颜色,用来通过换肤接口进行设置的
     * @param titleColor
     * @param contentColor
     */
    public void setEmptyStateColor(int titleColor, int contentColor) {
    	emptyStateTitleTextColor = titleColor;
    	emptyStateContentTextColor = contentColor;
    	if(emptyStateTitleTextView == null)
    		return;
    	emptyStateTitleTextView.setTextColor(emptyStateTitleTextColor);
        emptyStateContentTextView.setTextColor(emptyStateContentTextColor);
        emptyStateImageView.setImageDrawable(
    ...
    /**
     * 设置错误状态下的颜色,用来通过换肤接口进行设置的
     * @param titleColor
     * @param contentColor
     */
    public void setErrorStateColor(int titleColor, int contentColor) {
    	errorStateTitleTextColor = titleColor;
    	errorStateContentTextColor = contentColor;
    	if(errorStateTitleTextView == null)
    		return;
     ...
     * @param drawable
     */
    public void setErrorStateColor(int titleColor, int contentColor, Drawable drawable) {
    	errorStateTitleTextColor = titleColor;
    	errorStateContentTextColor = contentColor;
    ...
    private void setErrorView() {
        if (errorStateRelativeLayout == null) {
            view = inflater.inflate(R.layout.roma_libs_progress_error_view, null);
