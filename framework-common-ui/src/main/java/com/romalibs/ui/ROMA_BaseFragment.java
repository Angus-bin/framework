 ...
 * @version 1.0 
 */
public class ROMA_BaseFragment extends Fragment implements ROMA_SkinManager.OnSkinChangeListener{

	private View rootView;
	private LayoutInflater inflater;
	private RelativeLayout fl_keyboard_root;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		rootView = inflater.inflate(R.layout.roma_libs_base_ui_layout, null);
		return rootView;
	}
	...
	private void initKeyBoard() {
		...
		if (kdsKeyBoardView == null) {
			kdsKeyBoardView = new Kds_KeyBoardView(this.getActivity());
	...
	/**
	 * 设置添加主界面接口 
	 * @param titleLayoutResID 自定义标题栏的布局资源 ID。
	...
	public void setContentView(int layoutResID) { 
		...
		if(contentParent == null || titleParent == null){
			//初始化title
			titleParent = (FrameLayout) rootView.findViewById(R.id.fl_title);
			
			//初始化content
			contentParent = (UICenterProgressLayout) rootView.findViewById(R.id.content);
		
			 fl_keyboard_root= (RelativeLayout)rootView.findViewById(R.id.fl_keyboard_root);
		}
		...
		rightBt = (TextView) rootView.findViewById(R.id.right);
		backBt = (TextView) rootView.findViewById(R.id.back);
		if(backBt != null)
