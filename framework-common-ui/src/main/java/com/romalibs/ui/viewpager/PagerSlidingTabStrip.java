...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public RomaViewPager.OnPageChangeListener mDelegatePageListener;
    private RomaViewPager mPager;
...
//        }
    ...
    public void setViewPager(RomaViewPager pager) {
        this.mPager = pager;
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (isCustomTabs) {
                ...
                tabView = LayoutInflater.from(getContext()).inflate(R.layout.roma_libs_psts_tab, this, false);
            }
    ...
    private void updateTabStyles() {
        Logger.d("mTabTextSize", "mTabTextSize = " + mTabTextSize);
        for (int i = 0; i < mTabCount; i++) {
    ...
    public void setOnPageChangeListener(RomaViewPager.OnPageChangeListener listener) {
        this.mDelegatePageListener = listener;
    }

    private class PageListener implements RomaViewPager.OnPageChangeListener {
        ...
        public void onPageScrollStateChanged(int state) {
            if (state == RomaViewPager.SCROLL_STATE_IDLE) {
    ...
    public void setShouldExpand(boolean shouldExpand) {
        ...
        for(int i=0; i<count; i++){
            mTabsContainer.getChildAt(i).setLayoutParams(mTabLayoutParams);
        }
        if (mPager != null) {
            requestLayout();
        }
